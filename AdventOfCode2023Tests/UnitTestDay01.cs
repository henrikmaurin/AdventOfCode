...
namespace Tests
{
    ...
    public class UnitTestDay01
    {
        ...
        {
            int sum = DocumentDecoder.Findfirst(data, false) * 10 + DocumentDecoder.FindLast(data, false);
        ...
        public void Part2_Examples(int result, string data)
        {
            ...
            int sum = DocumentDecoder.Findfirst(data, true) * 10 + DocumentDecoder.FindLast(data, true);
